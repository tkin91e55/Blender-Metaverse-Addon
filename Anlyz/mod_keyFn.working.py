...
#There is function wrapper def fbx_metav_toolset_data_material_elements(root, ma, scene_data)
...
# There is function wrapper: def fbx_metav_toolset_data_texture_file_elements(root, blender_tex_key, scene_data):
